<template>
  <div class="hero-top-component">
    <div class="hero landing-page-background">
      ...
      <p
        class="description"
      >Quark Studio is a powerful app builder that delivers a smooth developer experience for teams building with Ionic. Get started with the fastest and easiest way to create award-winning cross-platform apps, from a single tool.</p>
      <p class="action">
